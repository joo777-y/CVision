...
const BagIcon      = ({ s = 16 }) => <Ico size={s}><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16"/></Ico>;
const MailIcon     = ()           => <Ico size={15}><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></Ico>;
const PhoneIcon    = ()           => <Ico size={15}><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 8.81 19.79 19.79 0 01.1 2.18 2 2 0 012.09 0h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 14.92z"/></Ico>;
const PinIcon      = ()           => <Ico size={15}><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></Ico>;
const GlobeIcon    = ()           => <Ico size={15}><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z"/></Ico>;
const FileIcon     = ()           => <Ico size={15}><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></Ico>;
const GradCapIcon  = ()           => <Ico size={18}><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3.33 1.67 6.67 1.67 10 0v-5"/></Ico>;
const ArrowLeft    = ()           => <Ico size={15}><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></Ico>;
const XIcon        = ()           => <Ico size={14}><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></Ico>;
const CheckIcon    = ()           => <Ico size={14}><polyline points="20 6 9 17 4 12"/></Ico>;
    ...
    <div className="flex items-center justify-center my-4">
      <div className="relative w-36 h-36">
        <svg className="w-full h-full -rotate-90" viewBox="0 0 128 128">
          <circle cx="64" cy="64" r={r} fill="none" stroke="#e8f0fe" strokeWidth="10" />
  ...
  return (
    <div className="flex gap-4">
      ...
      <div className="flex-1 min-w-0 pb-5 border-b border-gray-100 last:border-0 last:pb-0">
        ...
        <p className="text-xs text-gray-400 mb-2">{item.from} — {item.to}</p>
...
export default function CandidateDetailPage({ candidateId, onBack, onStatusChange }) {
  // ── Connect to backend: ───────────────────────────────────────────────────────
        ...
        <div className="flex flex-col gap-5 flex-1 min-w-0">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 px-5 py-5">
            <div className="flex items-center gap-2 mb-5">
              <span className="text-gray-400"><BagIcon s={16} /></span>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 px-5 py-5">
            <div className="flex items-center gap-2 mb-5">
              <span className="text-gray-400"><GradCapIcon /></span>
